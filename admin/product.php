...
if(isset($_POST['load']))
{
	...
	$sql = "INSERT INTO product (image, name, productname, price, description) VALUES ('$image', '$name', '$addprod', '$addprice', '$desc')";
  ...
  <body>
	...
	<div class="cdiv">
		...
		<tbody>
			...
			<td><?php echo '<img height="100" width="100" src="data:image;base64,'.base64_encode($row['image']).' ">';?></td>
