	...
	<div class="cdiv">
		<div class="row">
			<div class="col-md-4 glyphicon glyphicon-question-sign gi-2x" style="text-align:center">Still Have Questions? 
				<p>Take a moment to jot down your questions, we'll be happy to answer them.</p><br>
...
if(isset($_POST['sub']))
{
	...
	if($name == "")
		...
		echo "<script> alert('Please leave a message so we can answer your concern.') </script>";
	
	$query = mysql_query("INSERT INTO contact (fullname, email, message) VALUES ('$name', '$email', '$msg')");
	if(!$query)
