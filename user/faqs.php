...
<body style="background-color:lavender">
  ...
  <body>
	...
	<div class="row">
		<h1 align="center" class="col-md-12"> "We are selling a Product that ISO-19002 passed :)";</h1>
		<h1 align="center" class="col-md-12"> "We will asure you that all product is made in GERMANY !"</h1> 
	</div>
